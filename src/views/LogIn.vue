<template>
  <div>
    ...
    <v-row justify="space-between">
      ...
      <v-col cols="6">
        <v-card class="text-center ma-8 px-3 py-3 rounded-lg" elevation="3" tile color="rgb(255, 255, 255, 0.95)">
          ...
          <v-btn to="./Register" elevation="0" color="transparent" class="teal--text">Don't have an account? Sign In
          </v-btn>
        </v-card>
      </v-col>
    </v-row>
