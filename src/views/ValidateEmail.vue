        ...
        <v-card class="rounded-lg text-center ma-8 px-3 py-3" elevation="3" tile
          ...
          <v-list-item three-line>
            <v-list-item-content>
              ...
              <v-list-item>
                <v-text-field v-model="email" label="Email" outlined color="teal" @blur="$v.email.$touch()"
                              :error-messages=emailErrors
                              hint="Type again your email here."></v-text-field>
              </v-list-item>
              <v-list-item>
                <v-text-field v-model="token" label="Token" outlined color="teal" @blur="$v.token.$touch()"
